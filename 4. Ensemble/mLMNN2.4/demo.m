...
err=knnclassifytreeomp([],xTr, yTr,xTe,yTe,1);fprintf('\n');
...
fprintf('\n')
L0=pca(xTr)';
err=knnclassifytreeomp(L0(1:3,:),xTr, yTr,xTe,yTe,1);fprintf('\n');
...
err=knnclassifytreeomp(L,xTr, yTr,xTe,yTe,1);fprintf('\n');
...
err=knnclassifytreeomp([],embed(xTr), yTr,embed(xTe),yTe,1);fprintf('\n');
